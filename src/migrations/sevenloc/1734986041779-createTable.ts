...
export class CreateTable1734986041779 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "Permissao" ("id" SERIAL NOT NULL, "criado_em" TIMESTAMP NOT NULL DEFAULT now(), "criado_por" character varying(50) NOT NULL, "alterado_em" TIMESTAMP NOT NULL DEFAULT now(), "alterado_por" character varying(50) NOT NULL, "nome" character varying(100) NOT NULL, "descricao" character varying(100) NOT NULL, CONSTRAINT "PK_78ec25941033109a7ce02ac938f" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "Usuarios" ("id" SERIAL NOT NULL, "criado_em" TIMESTAMP NOT NULL DEFAULT now(), "criado_por" character varying(50) NOT NULL, "alterado_em" TIMESTAMP NOT NULL DEFAULT now(), "alterado_por" character varying(50) NOT NULL, "email" character varying(150) NOT NULL, "nome" character varying(100) NOT NULL, "senha" character varying(255) NOT NULL, "status" character varying(50) NOT NULL, CONSTRAINT "PK_6b4c9e5c7d35b294307b3fd0fea" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "Grupos" ("id" SERIAL NOT NULL, "criado_em" TIMESTAMP NOT NULL DEFAULT now(), "criado_por" character varying(50) NOT NULL, "alterado_em" TIMESTAMP NOT NULL DEFAULT now(), "alterado_por" character varying(50) NOT NULL, "nome" character varying(100) NOT NULL, CONSTRAINT "PK_27106a912a4e36face11c5c50ad" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "Usuarios_por_grupos" ("id" SERIAL NOT NULL, "criado_em" TIMESTAMP NOT NULL DEFAULT now(), "criado_por" character varying(50) NOT NULL, "alterado_em" TIMESTAMP NOT NULL DEFAULT now(), "alterado_por" character varying(50) NOT NULL, "usuario_id" integer NOT NULL, "grupo_id" integer NOT NULL, CONSTRAINT "PK_b69a69f2d2f720d1d81ef7a24d3" PRIMARY KEY ("id", "usuario_id", "grupo_id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "Permissoes_por_grupo" ("id" SERIAL NOT NULL, "criado_em" TIMESTAMP NOT NULL DEFAULT now(), "criado_por" character varying(50) NOT NULL, "alterado_em" TIMESTAMP NOT NULL DEFAULT now(), "alterado_por" character varying(50) NOT NULL, "permissao_id" integer NOT NULL, "grupo_id" integer NOT NULL, "permissionId" integer, CONSTRAINT "PK_9c9b24a296a43aa8537d559ac0d" PRIMARY KEY ("id", "permissao_id", "grupo_id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "Usuarios_por_grupos" ADD "criado_por" character varying(50) NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "Usuarios_por_grupos" ADD "alterado_em" TIMESTAMP NOT NULL DEFAULT now()`,
    );
    await queryRunner.query(
      `ALTER TABLE "Usuarios_por_grupos" ADD "alterado_por" character varying(50) NOT NULL`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "Permissoes_por_grupo" ADD "criado_por" character varying(50) NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "Permissoes_por_grupo" ADD "alterado_em" TIMESTAMP NOT NULL DEFAULT now()`,
    );
    await queryRunner.query(
      `ALTER TABLE "Permissoes_por_grupo" ADD "alterado_por" character varying(50) NOT NULL`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "Usuarios_por_grupos" ADD CONSTRAINT "FK_794151d4c78ad60ecdf80584b76" FOREIGN KEY ("usuario_id") REFERENCES "Usuarios"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "Usuarios_por_grupos" DROP CONSTRAINT "FK_794151d4c78ad60ecdf80584b76"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "Permissoes_por_grupo" ADD CONSTRAINT "PK_9c9b24a296a43aa8537d559ac0d" PRIMARY KEY ("id", "permissao_id", "grupo_id")`,
    );
    await queryRunner.query(
      `ALTER TABLE "Usuarios_por_grupos" ADD "alterado_por" character varying(50) NOT NULL`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "Usuarios_por_grupos" ADD CONSTRAINT "PK_b69a69f2d2f720d1d81ef7a24d3" PRIMARY KEY ("id", "usuario_id", "grupo_id")`,
    );
