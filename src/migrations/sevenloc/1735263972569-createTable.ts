...
export class CreateTable1735263972569 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "Arquivos" ADD CONSTRAINT "FK_786dc09a3b4b0077cac2c16202e" FOREIGN KEY ("fornecedor_id") REFERENCES "Fornecedores"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "Arquivos" DROP CONSTRAINT "FK_786dc09a3b4b0077cac2c16202e"`,
    );
    await queryRunner.query(
      `ALTER TABLE "Usuarios_por_grupos" DROP CONSTRAINT "FK_e2682c8864379b9c60f524db59c"`,
    );
